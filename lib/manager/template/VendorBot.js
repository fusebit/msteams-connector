...
class VendorBot extends FusebitBot {
    ...
    async getBoundaryIdForTeamsUser(id) {
        // Base class returns 'msteams-user-{first-40-characters-of-hex-encoded-sha1-of-id};
        return super.getBoundaryIdForTeamsUser(id);
    }
    ...
    async getFunctionIdForTeamsUser(id) {
        // Base class returns 'msteams-handler'
        return super.getFunctionIdForTeamsUser(id);
    }
