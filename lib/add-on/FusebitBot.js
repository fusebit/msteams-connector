...
`
        ...
        try {
            ...
            Sdk.deleteFunction(ctx, undefined, undefined, context.fusebit.fusebit.functionAccessToken);
            throw e;
        }
    ...
    _getSyntheticFusebitFunctionContextFromTurnContext(context) {
        return { body: {
            ...
            boundaryId: this._getBoundaryIdForTeamsUser(context.activity.from.id),
            functionId: 'msteams-handler'
        }};
    }
    ...
    _getSyntheticFusebitFunctionContextFromUserContext(fusebitContext, userContext) {
        return { body: {
            ...
            boundaryId: this._getBoundaryIdForTeamsUser(userContext.teamsUser.user),
            functionId: 'msteams-handler'
        }};
    }
